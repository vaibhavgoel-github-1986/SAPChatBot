def get_sap_agent_prompt():
    ...
    system_prompt_text = """
        ...
        Your goal is to provide  accurate, maintainable, and efficient  unit test cases that align with  ABAP best practices , ensuring comprehensive test coverage and high code quality.
    """
